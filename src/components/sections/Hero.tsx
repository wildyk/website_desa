...
const defaultProfil = {
  captionUtama: 'Dusun Maju, Sejahtera & Bermartabat',
  subcaption: 'Portal digital resmi dusun untuk informasi publik dan kegiatan masyarakat.',
}
...
export default function Hero() {
  ...
  return (
    <section id="beranda" style={{ minHeight: '100vh', backgroundImage: 'url("/images/hero.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '120px 5% 80px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="anim-1" style={{ display: 'inline-block', background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.25)', color: 'rgba(255,255,255,0.92)', fontSize: 14, fontWeight: 600, padding: '8px 18px', borderRadius: 100, marginBottom: 28, zIndex: 2 }}>🌿 Website Resmi Dusun Rejosari</div>
      ...
      <div className="anim-4" style={{ marginBottom: 54, zIndex: 2 }}><a href="/#profil" style={{ background: '#fff', color: '#1D6A3A', padding: '16px 34px', borderRadius: 14, fontWeight: 700, fontSize: 16, textDecoration: 'none', boxShadow: '0 12px 30px rgba(0,0,0,0.18)' }}>Profil Dusun</a></div>
